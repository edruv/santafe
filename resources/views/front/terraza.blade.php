		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 p-2">
					...
					<div class="col-12 px-0 py-2 order-0 order-sm-1">
						<div class="text-center h-100 p-3 d-flex align-items-center" style="background:#ededed;">
							<div>
								...
								<div class="">
									Lorem ipsum dolor sit amet, consectetur adipisicing elit. Optio, aspernatur totam culpa, consequatur laboriosam odio sint magni impedit suscipit modi neque saepe veniam reprehenderit veritatis. Unde ducimus et ea enim.
								</div>
							</div>
						</div>
					</div>
				</div>
				<div class="col-12 col-md-8 p-2 order-1 order-sm-0">
					<div class="bg-santafe-sua text-white">
						<div class="p-3">
							...
							<div class="d-flex justify-content-between align-items-end">
								<div class="">
									<a href="" class="btn" style="background:#fff;border-radius: 1.5em;width:10em;">Contactar</a>
								</div>
								<div>
