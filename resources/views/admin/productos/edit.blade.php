			...
			<div class="card-body">
				<form action="{{route('productos.update',$product->id)}}" method="post">
					...
					<div class="form-group text-center">
						...
						<textarea name="descripcion_rapida" id="descripcion_rapida" rows="4" class="texteditor form-control" style="resize:none;">{{ $product->descripcion_rapida }}</textarea>
					</div>
					<div class="form-group text-center">
					...
					<div class="col-md form-group">
						...
						<input type="text" name="ciudad" id="ciudad" class="form-control" value="{{ $product->ciudad }}">
					</div>
