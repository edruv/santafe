	...
	<nav class="navbar navbar-expand-md navbar-dark" aria-label="navbar">
		<div class="container">
			<a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
				<img src="{{ asset('img/design/logo.jpg') }}" alt="logo.jpg" class="bi me-2" style="height:3em;">
			</a>
				...
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
					<li class="nav-item dropdown mx-md-3">
						...
						<ul class="dropdown-menu" aria-labelledby="dropdown01">
							@foreach ($prods as $prod)
								@if ($prod->categoria == 1)
									<li><a class="dropdown-item text-uppercase py-2" href="{{ route('front.empresarial',$prod->id) }}">{{$prod->nombre}}</a></li>
								@endif
							@endforeach
						</ul>
					</li>
					<li class="nav-item dropdown mx-md-3">
						...
						<ul class="dropdown-menu" aria-labelledby="dropdown02">
							@foreach ($prods as $prod)
								@if ($prod->categoria == 2)
									<li><a class="dropdown-item text-uppercase py-2" href="{{ route('front.social',$prod->id) }}">{{$prod->nombre}}</a></li>
								@endif
							@endforeach
						</ul>
					</li>
					<li class="nav-item dropdown mx-md-3 my-auto">
						...
						<ul class="dropdown-menu" aria-labelledby="dropdown03">
							@foreach ($prods as $prod)
								@if ($prod->categoria == 3)
									<li><a class="dropdown-item text-uppercase py-2" href="{{ route('front.musica',$prod->id) }}">{{$prod->nombre}}</a></li>
								@endif
							@endforeach
						</ul>
					</li>
					<li class="nav-item dropdown mx-md-3 my-auto d-none">
						...
						<ul class="dropdown-menu" aria-labelledby="dropdown04">
							@foreach ($prods as $prod)
								@if ($prod->categoria == 4)
									<li><a class="dropdown-item text-uppercase py-2" href="{{ route('front.recinto',$prod->id) }}">{{$prod->nombre}}</a></li>
								@endif
							@endforeach
						</ul>
					</li>
